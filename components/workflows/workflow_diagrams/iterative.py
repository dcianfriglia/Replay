...
def render_iterative_diagram():
    """Render Iterative Refinement workflow diagram"""
    ...
    <div class="workflow-diagram">
        ...
        <p class="diagram-caption">The Iterative Refinement workflow with feedback loop</p>
    </div>
    """
